"""Mock getdevModeSettingList response for a legacy controller (devType=11).

Captured from a live devType=11 device, Port 1.
devId and modeSetid are redacted.
"""

LEGACY_DEV_ID = "REDACTED_DEV_ID"

# Full 142-field response dict as returned by getdevModeSettingList for Port 1.
# Used in read-before-write tests (Quirk 13).
MOCK_MODE_SETTINGS_LEGACY_PORT1: dict = {
...
# Flat-only view of Port 1 (what get_mode_settings returns after filtering nested keys).
# This is the input to build_write_payload for legacy controllers.
MOCK_MODE_SETTINGS_LEGACY_PORT1_FLAT: dict = {
    k: v
    for k, v in MOCK_MODE_SETTINGS_LEGACY_PORT1.items()
